import { IMPONEXPO_SUPERUSER_KEY, } from "../../data/others/EnvironmentVariables.js";
...
import { checkIsAdmin, } from "../../custom-functions/middlewares/admin/adminMiddlewares.js";
import { bannedSubjectDataModelMongoDbMongoose } from "../../models/mongodb/others/schemas2.model.js";
import { ARCHDUNE_ADMIN_JWT_KEY, ARCHDUNE_SUPER_USER_PASSWORD, } from "../../data/archdune/variables/ArchduneVariables.js";
import mongoose from "mongoose";
import ArchDuneCheckAdmin, { ArchDuneCheckAdminFromForm, } from "../../custom-functions/archdune/ArchDuneCheckAdmin.js";
...
const makingSomeoneAdminController = async (request, response) => {
    try {
...
const giveUserPermissionToSellController = async (request, response) => {
    try {
...
const removeUserPermissionToSellController = async (request, response) => {
    try {
        await checkIsAdmin(request);
        const receivedData = request.body;
...
const banSubjectController = async (request, response) => {
    try {
        // CHECK IF ADMIN---------------------------------------------------------------------------------------------------
        await checkIsAdmin(request);
...
const unBanSubjectController = async (request, response) => {
    try {
        // CHECK ADMIN OR NOT--------------------------------------------------------------------------------------------------------
        await checkIsAdmin(request);
        //  Remove USER FROM BANLIST----------------------------------------------------------------------------------------------------------
...
const deleteProductByAdminController = async (request, response) => {
    try {
        // CHECK IF IS ADMIN---------------------------------------------------------------------------------------------------------
        await checkIsAdmin(request);
...
const approveProductController = async (request, response) => {
    try {
        // CHECK IF IS ADMIN---------------------------------------------------------------------------------------------------------
        await checkIsAdmin(request);
...
const seeingUserDetailsByAdminController = async (request, response) => {
    try {
        // CHECK IF IS ADMIN---------------------------------------------------------------------------------------------------------
        await checkIsAdmin(request);
        // FIND THE PRODUCT FROM PRODUCTS TO BE APPROVED DATABASE------------------------------------------------------------------------------
...
const gettingReportsMadeByUserController = async (request, response) => {
    try {
        // CHECK IF IS ADMIN---------------------------------------------------------------------------------------------------------
        await checkIsAdmin(request);
...
const gettingUsersDataController = async (request, response) => {
    try {
        // CHECK IF IS ADMIN---------------------------------------------------------------------------------------------------------
        await checkIsAdmin(request);
        // GET REPORTS FROM DATABASE------------------------------------------------------------------------------
...
const gettingUserDetailsForAdminController = async (request, response) => {
    try {
        // CHECK IF IS ADMIN---------------------------------------------------------------------------------------------------------
        await checkIsAdmin(request);
        const receivedData = request.body;
...
export { makingSomeoneAdminController, giveUserPermissionToSellController, banSubjectController, deleteProductByAdminController, unBanUserController, approveProductController, seeingUserDetailsByAdminController, gettingReportsMadeByUserController, gettingUsersDataController, gettingUserDetailsForAdminController, unBanSubjectController, removeUserPermissionToSellController, };
export const giveAdminTokenController = async (request, response) => {
    try {
        const receivedData = request.body;
...
export const authorizeAdminTokenController = async (request, response) => {
    try {
        const receivedData = request.body;
...
export const uploadNewProjectController = async (request, response) => {
    try {
...
export const updateProjectDataController = async (request, response) => {
    try {
